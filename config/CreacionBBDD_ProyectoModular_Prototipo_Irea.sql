...
CREATE TABLE IF NOT EXISTS USUARIO_REGISTRADO (
    ...
    FOREIGN KEY (ID_USUARIO_REGISTRADO) REFERENCES USUARIOS (ID_USUARIO)
		ON DELETE CASCADE	
        ON UPDATE CASCADE
)ENGINE = INNODB;
...
CREATE TABLE IF NOT EXISTS suscritos (
	ID_SUSCRITO INT UNSIGNED NOT NULL,
	-- KEYS Y CONSTRAINS 
	PRIMARY KEY (ID_SUSCRITO),
	FOREIGN KEY (ID_SUSCRITO) REFERENCES USUARIOS (ID_USUARIO)
		ON DELETE CASCADE
		ON UPDATE CASCADE
) ENGINE = INNODB;
...
CREATE TABLE IF NOT EXISTS PARTIDAS (
   ...
   FOREIGN KEY (DIRECTOR_PARTIDA) REFERENCES ADMINISTRADORES (ID_ADMINISTRADOR)
		ON DELETE RESTRICT
      ON UPDATE CASCADE,
