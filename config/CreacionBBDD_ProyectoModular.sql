...
/*GRANT SELECT, INSERT ON PROYECTO_MODULAR.USUARIOS TO 'a2da_conexion'@'localhost' IDENTIFIED BY '1234';
...
GRANT SELECT ON PROYECTO_MODULAR.SUSCRIPCIONES TO 'a2da_conexion'@'localhost';
